...
# coding=utf-8
# Coded By Angga Ady
# My Facebook ( https://www.facebook.com/shahdinobaloch15 )
...
# LO KONTOL
logo = ''' \033[0;96m _______ ______  ___________ __________
 \033[0;96m ___    |___   |/  /___  __ )___  ____/ ® \033[0m|| Created By  SHAH DINO
 \033[0;96m __  /| |__  /|_/ / __  __  |__  /_         \033[0m|| Github.com/DINO
 \033[0;96m _  ___ |_  /  / /  _  /_/ / _  __/   \033[0;91mv3.5  \033[0m|| Facebook.com/shahdinobaloch15
 \033[0;96m /_/  |_|/_/  /_/   /_____/  /_/
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        print '\n\n [%s!%s]  tidak mendapatkan hasil  :('%(M,N);exit()
...
def info_tools():
    ...
    print '\n %s[%s>%s] Yt       : Angga XD.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Author   : Angga Ady.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/Dino'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/shahdinobaloch15'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Instagram: https://www.instagram.com/Anggatp55'%(N,H,N);time.sleep(0.07)
    ...
    def __api__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            try:
            	...
            	_kontol = 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.85 Safari/537.36'
